  ...
  return (
    <div className="position-relative">
       <FormGroup style={{marginBottom:'20px'}} className="shadow p-2 position-sticky filter-form">
        ...
        <Form.Label id="comm" className="m-2 p-2"><b>Commodity</b></Form.Label>
        <Form.Control as="select" name="comm" className="m-2" value={scommodity} onChange={setCommodity}>
            ...
            return (
              ...
              <Card  className="back-shadow ">
                ...
                <ListGroup className="list-group-flush">
                  <ListGroupItem>
                      <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-3 text-danger"></FontAwesomeIcon>{marketCenter}
                  </ListGroupItem>
                  <ListGroupItem><FontAwesomeIcon icon={faSeedling} className="mr-3 text-success"></FontAwesomeIcon>{commodity}</ListGroupItem>
                  <ListGroupItem><FontAwesomeIcon icon={faStore} className="mr-3 text-info"></FontAwesomeIcon>There are {Math.ceil(Math.random()*(20) + 30)} shops</ListGroupItem>
                  <ListGroupItem><FontAwesomeIcon icon={faRupeeSign} className="mr-3" style={{color:"goldenrod"}}></FontAwesomeIcon>{modalPrice} (Modal)</ListGroupItem>
                </ListGroup>
                <Card.Body>
                <Button variant="outline-success" block>Enter {marketCenter.split(',')[0].toUpperCase()} Mandi</Button>
                </Card.Body>
              </Card>
              </div>
            )
